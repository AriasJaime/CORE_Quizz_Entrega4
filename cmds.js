...
const validateId = id => {
    return new Sequelize.Promise((resolve, reject) => {
        if(typeof id === "undefined"){
            ...
            id = parseInt(id);
            if(Number.isNaN(id)){
                reject(new Error(`El parámetro id no es un número válido.`));
            }else{
                resolve(id);
            }
        }
 ...
 */
exports.addCmd = rl => {
    makeQuestion(rl, 'Introduzca una pregunta nueva: ')
        .then(q => {
            return makeQuestion(rl, 'Introduzca la respuesta correcta: ')
                .then(a =>{
...
exports.editCmd = (rl, id) => {
    ...
    .then(quiz => {
        ...
        return makeQuestion(rl, 'Introduzca una pregunta nueva: ')
            .then(q => {
...
exports.creditsCmd = rl => {
    ...
    log('Jaime Arias Buzunáriz', 'green');
    rl.prompt();
};
